<html>
    ...
    <body>
        ...
        <img class="image one" src="img/space.gif" />
        <img class="image two" src="img/vaccine.jpg" />
        <img class="image three" src="img/disney.jpg" />
        <img class="image four" src="img/usa.png" />
        <a class="link one" href="../destination/">Keeping Your Family Safe</a>
        <a class="link two" href="../resurrection/">Alive</a>
        <p class="truth">シークレットナレッジアメリカ </p>
        <p class="background-text">The committees met, pursuant to notice, at 9:07 a.m. in room 1202,
...
additional records or information were forthcoming. And no oneno single individual--could be found who remembered the details, not
...
The Central Intelligence Agency drugged American citizens without their knowledge or consent. It used university facilities and personnel without their knowledge. It funded leading researchers, often
...
[The prepared statement of Admiral Turner follows:]The committees met, pursuant to notice, at 9:07 a.m. in room 1202,
Dirksen Senate Office Building, Senator Daniel K. Inouye-(chairman -
of the Select Committee on Intelligence) presiding.
Present: Senators Inouye (presiding), Kennedy, Goldwater, Bayh,
Hathaway, Huddleston, Hart, Schweiker, Case, Garn, Chafee, Lugar
...
Senator INOUITE. Thank you very much. Now we will proceed with
the hearings.. Admiral Turner?
[The prepared statement of Admiral Turner follows:]</p>
        <audio id="music" src="sounds/music.mp3" loop="loop"></audio>
    </body>
</html>